...
public class C06_BeforeClassAfterClass {
 ...
 1. method'da amazon anasayfaya gidip amazon'da oldugunuzu test edin
2. method'da arama kutusuna Nutella yazip aratin ve sonuc yazisinin Nutella icerdigini test edin
3. method'da ilk Nutella urunune tiklayip urun isminin Nutella icerdigini test edin  */
   ...
   if (actualSonucYazisi.equals(expectedIcerik)){
